...
//       selectedBox.insertBefore(tag, selectedBox.querySelector('.placeholder'));
...
//     selectedProcedures.length ? 'none' : 'inline';
...
// paidAmountInput?.addEventListener('input', calculateFinal);
...
//   finalAmountText.textContent = final.toFixed(2);
// }
...
//     notyf.error("Select at least one procedure");
//     return;
//   }
...
//   if (total <= 0) {
//     notyf.error("Total must be greater than zero");
//     return;
//   }
...
//     } else {
//       notyf.error(result.error || "Invoice save failed");
//     }
