...
<div class="form-section">
    ...
    <form id="labOrderForm" action="<?= base_url('laborders/save') ?>" method="post">
        ...
        <button type="submit" class="btn-add-appt" style="margin-top:15px;">
            Place Order
        </button>
    ...
    <div style="text-align:center; margin-top:30px;">
        <a href="<?= base_url('laborders/history') ?>" class="btn-add-appt">
...
if(successDiv){
    const msg = successDiv.dataset.message || "Your order has been placed successfully!";
    notyf.success(msg);
}
...
if(errorDiv){
    const msg = errorDiv.dataset.message || "Something went wrong!";
    notyf.error(msg);
}
</script>
